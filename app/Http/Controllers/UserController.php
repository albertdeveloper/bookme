...
class UserController extends Controller
{
    ...
    {
        return Inertia::render('Admin/UserManagement/User/Index',[
            'filters' => request()->only('search'),
            'users' => $this->userRepository->get(request()->only('search')),
        ]);
    }
    ...
    {
        return Inertia::render('Admin/UserManagement/User/Create');
    }
