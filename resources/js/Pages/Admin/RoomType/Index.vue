<template>
    <app-layout>
        ...
        <div class="p-6">
            <InertiaLink preserve-state preserve-scroll :href="route('admin.room_type.create')"
            ...
            <div class="mt-6 rounded" v-if="roomTypes.data.length > 0">
                <div class="shadow overflow-x-auto">
                    <table class="w-full whitespace-no-wrap">
                        ...
                        <tr v-for="roomType in roomTypes.data">
                            <td class="px-6 py-4 flex items-center focus:text-indigo-500 border-t">
                                <InertiaLink :href="route('admin.room_type.edit',{id:roomType.id})">
                                    {{ roomType.title }}
                                </InertiaLink>
                            </td>
